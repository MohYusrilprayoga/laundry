  ...
  <nav class="navbar navbar-expand-lg">
    ...
    <br><br>
        ...
        <?php
                ...
                $id = $_GET['id'];
                $data = mysqli_query($konek,"select * from pelanggan where pelanggan_id='$id'");
                while($d=mysqli_fetch_array($data)){
        ?>
        <form class="row g-3" method="post" action="pelanggan_update.php">
        <div class="col-md-6">
        ...
        <div class="col-12">
          ...
          <input type="text" class="form-control" name="alamat" placeholder="Masukkan alamat" value="<?php echo $d['pelanggan_alamat']; ?>"></input>
          </div>
        </div>
        <div class="col-md-1">
            <button type="submit" class="btn btn-outline-dark" value="Update">Update</button>
        </div>
        <div class="col-md-6">
