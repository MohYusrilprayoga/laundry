      ...
      <div class="card-body">
        <div class="panel">
         <div class="panel-body">
            <a href="pelanggan_tambah.php" class="btn btn-sm btn-info pull-right"><i class='bx bx-folder-plus'></i> Tambah</a>
            <br/>
            <br/>
            <table class="table table-bordered table-striped">
                ...
                while($d=mysqli_fetch_array($data)){
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="pelanggan_edit.php?id=<?php echo $d['pelanggan_id']; ?>" class="btn btn-sm btn-info"><i class='bx bxs-edit'></i> Edit</a>
                            <a href="pelanggan_hapus.php?id=<?php echo $d['pelanggan_id']; ?>" class="btn btn-sm btn-danger"><i class='bx bx-x'></i> Hapus</a>
                        </td>
                    </tr>
                    <?php
                }
                      ?>
                  <p>*Setiap pemesanan yang selesai dilakukan, jangan lupa untuk menghapusnya secara rutin, Okeh?</p>
                  </table>
              </div>
          </div>
      </div>
