    ...
    <div class="card">
      ...
      <div class="panel">
        <div class="panel-body">
            <a href="transaksi_tambah.php" class="btn btn-sm btn-info pull-right"><i class='bx bx-folder-plus'></i> Transaksi Baru</a>
            <br/>
            <br/>
                ...
                while($d=mysqli_fetch_array($data)){
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="transaksi_edit.php?id=<?php echo $d['transaksi_id']; ?>" class="btn btn-sm btn-info"><i class='bx bxs-edit'></i> Edit</a>
